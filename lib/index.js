...
var TextareaAutosize = function (_React$Component) {
  ...
  function TextareaAutosize(props) {
    ...
    _this._resizeComponent = function () {
      ...
      var nodeHeight = (0, _calculateNodeHeight2.default)(_this._rootDOMNode, _this._uid, _this.props.iframeId, _this.props.useCacheForDOMMeasurements, _this.props.minRows, _this.props.maxRows);
  ...
  TextareaAutosize.prototype.render = function render() {
    var _props = this.props,
        ...
        _iframeId = _props.iframeId,
        props = _objectWithoutProperties(_props, ['minRows', 'maxRows', 'onHeightChange', 'useCacheForDOMMeasurements', 'inputRef', 'iframeId']);
  ...
  TextareaAutosize.prototype.componentWillUnmount = function componentWillUnmount() {
    this._clearNextFrame();
    (0, _calculateNodeHeight.clearHiddenTextarea)(this.props.iframeId);
