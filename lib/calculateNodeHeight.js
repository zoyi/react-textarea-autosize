...
exports.clearHiddenTextarea = clearHiddenTextarea;
...
function calculateNodeHeight(uiTextNode, uid, iframeId) {
  var useCache = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  var minRows = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
  var maxRows = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : null;

  if (!hiddenTextarea) {
    hiddenTextarea = _isBrowser2.default && document.createElement('textarea');
...
function clearHiddenTextarea(iframeId) {
