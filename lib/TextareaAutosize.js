  ...
  _createClass(TextareaAutosize, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          props = _objectWithoutProperties(_props, ['valueLink', 'minRows', 'maxRows', 'onHeightChange', 'useCacheForDOMMeasurements', 'iframeId']);
    ...
    value: function _resizeComponent() {
      ...
      this.setState((0, _calculateNodeHeight2.default)(this._rootDOMNode, useCacheForDOMMeasurements, this.props.iframeId, this.props.rows || this.props.minRows, this.props.maxRows));
    }
